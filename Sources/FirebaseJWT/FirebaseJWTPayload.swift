...
public struct FirebaseJWTPayload: JWTPayload {
    ...
    public let firebase: FirebaseIdentities?
...
public struct FirebaseIdentities: Codable {
    public let identities: FirebaseIdentity?
    public let sign_in_provider: String?
}

public struct FirebaseIdentity: Codable{
    enum CodingKeys: String, CodingKey{
